...
Komendy workflow są zdefiniowane w `.agents/skills/` (auto-aktywowane przez opis lub wywoływane przez `/skills`).
Komendy referencyjne są w `.codex/prompts/`.

### Workflow
- `/fix-bug` — Diagnozuj i napraw buga (zna warstwy HTML/CSS/JS)
- `/implement-feature` — Wdróż funkcję (auto-skala pytań do rozmiaru)
- `/scaffold-component` — Scaffold nowej sekcji/modułu (HTML + CSS + JS)
- `/project-context` — Załaduj cheat sheet architektury projektu
...
- `/audit-responsive` — Audyt responsywności i mobile UX
- `/audit-assets` — Audyt assetów (obrazy/fonty)
- `/audit-html` — Audyt HTML (semantyka/poprawność)
- `/audit-css` — Audyt CSS
- `/content-copy-ux` — Copy + UX review
- `/content-form-review` — Przegląd formularzy
- `/project-cleanup` — Przegląd porządków w repo
- `/security-basics` — Podstawy bezpieczeństwa frontu
- `/deploy-checklist` — Checklist przed wdrożeniem
...
- Kod, commit messages i komentarze w kodzie — **po angielsku**, chyba że użytkownik poprosi inaczej.

## Workflow

- Nowe funkcje/sekcje: `/implement-feature` (auto-skala pytań)
...
- UX gate: heurystyki Nielsena + WCAG AA.
